...
const Terminal = () => {
  ...
  return (
    ...
    <div className={`w-full h-full p-2 text-sm md:text-xs bg-black/90 rounded-lg overflow-hidden border border-white/10`} onClick={() => inputRef.current?.focus()}>
      ...
      <div className="flex mt-2">
        ...
        <input
          ...
          className={`flex-1 bg-transparent border-none outline-none ${currentTheme.user} font-mono`}
          autoFocus
          autoComplete="off"
          spellCheck="false"
        />
